...
!function() {
  ...
  GameUI.prototype.loadStartPage = function() {
    ...
    this.body.innerHTML = `
      <div class="screen screen-start">
        <header>
          <h1>Tic Tac Toe</h1>
          <a href="#" class="button" id="one-player">One Player Game</a>
          <a href="#" class="button" id="two-players">Two Player Game</a>
    ...
    this.body.innerHTML = `
      <div class="board" id="board">
        <header>
          <h1>Tic Tac Toe</h1>
          <ul>
            <li class="players active" id="player1">${game.player1.name}</li>
            <li class="players" id="player2">${game.player2.name}</li>
          </ul>
        </header>
        <ul class="boxes"></ul>
      </div>
  ...
  GameUI.prototype.loadWinScreen = function(winnerClass, winnerName) {
    ...
    // Build HTML
    this.body.innerHTML = `
      <div class="screen screen-win ${winnerClass}" id="finish">
        <header>
          <h1>Tic Tac Toe</h1>
          <p class="message">${message}</p>
          <a href="#" class="button" id="start">New Game</a>
        </header>
      </div>
    `;
